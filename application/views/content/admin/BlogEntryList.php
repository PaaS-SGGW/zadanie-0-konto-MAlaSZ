...
<div class="w3-card-4 w3-margin w3-white">
    <div class="w3-container w3-teal">
        <h2><?php echo Language::$LANG['UI']['Title']['BlogEntriesList']; ?></h2>
    </div>
    <div class="w3-container w3-padding-32">
        ...
        <div class="w3-row w3-padding-16">
            ...
            <div class="w3-col s12 m1 l1 my-button w3-right">
                <p><button class="w3-button w3-padding-large w3-teal w3-text-white w3-border w3-col l12 m12 s12" onclick="NewBlogEntry();"><b> <?php echo Language::$LANG['UI']['Button']['NewEntry']; ?></b></button></p>
            </div>
        </div>
    </div>
...
<script>
    ...
    function DeletePost(Id) {
        request = $.ajax({
            type: "POST",
            url: "./content.php",
            data: {type:"ConstantPost",url:"Delete", Id:Id}
        });
    ...
    function EditPost(Id) {
        request = $.ajax({
            type: "GET",
            url: "./content.php",
            data: {type:"ConstantPost",url:"Edit", Id:Id}
        });
        request.done(
            function ( response ) {
