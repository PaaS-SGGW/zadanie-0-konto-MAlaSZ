...
<div class="w3-card-4 w3-margin w3-white">
    <div class="w3-container w3-teal">
        <h2><?php echo Language::$LANG['UI']['Title']['NewPost'];?></h2>
    </div>
    <div class="w3-container w3-padding-32">
        <form class="w3-container">
            ...
            <div class=" w3-padding-16">
                <label class="w3-text-teal"><b><?php echo Language::$LANG['UI']['PostForm']['Summary'];?></b></label>
                <textarea  id='PostSummary' class="w3-input w3-border w3-text-black" type="text" style="width:100%"></textarea>
            </div>
        </form>
        <div class="w3-row w3-padding-16">
            ...
            <div class=" w3-col s12 m1 l1 w3-right my-button">
                <p><button class="w3-button w3-padding-large w3-border w3-teal w3-text-white w3-col l12 m12 s12" onclick="AddEntry();"><b> <?php echo Language::$LANG['UI']['Button']['Send'];?></b></button></p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function AddEntry() {
        ...
        if($('#PostSummary').val().length === 0) {
            ShowError(<?php echo "'".Language::$LANG['UI']['Error']['CannotSendPost'] . "','" . Language::$LANG['UI']['Error']['SummaryEmpty']."'"; ?>);
            return;
        }
